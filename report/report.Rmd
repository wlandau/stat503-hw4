...
We also tried model based clustering to see if it will perform better. First we fit the model to fall 13. The VII specification with five clusters performs the best. Figure \ref{fig:mcfall13} show the  
```{r mcfall13, fig.cap="\\label{fig:mcfall13}Model based clustering of fall 13 in a parallel coordinates plot.", fig.height=7}
