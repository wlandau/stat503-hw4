...
Figure \ref{fig:mc_pca} shows a plot of the first two principle components colored by clusters for fall 2013. There are considerable overlappings between cluster 1 and 2, 2 and 3, and 4 and 5, suggesting rooms for improvement in terms of clustering. But we can still see patterns consistent with the parallel coordinate plot. 
